...
| 2026-08-30 | Audited the remaining owner-approved MLCF Q2/Q3 FY26 filings `psx:271712` and `psx:275425` without adding any source or OCR. | Both exact hash-bound PDFs contain later-page, direct consolidated three-month Revenue/PAT/EPS statements (Q2 page 32; Q3 page 28), but the current parser does not associate their headers and emits no v2 facts. This is a targeted parser/reconciliation work item, not evidence promotion; the qualification gate remains red. |
