...
| B — industrial/cement | expansion, hiring, procurement, maintenance, commissioning, or capacity | MLCF, LUCK, DGKC | Unselected | DGKC is the conditional financial-backfill front-runner only. Its PP-bag commissioning reference (`evt_c66c444c35780cf5951e`) is not a defensible case observation: date, full evidence context, and subsidiary attribution are unresolved. It must not seed a case. MLCF/ LUCK currently have no stronger retained dated industrial event. |
...
| 1 | Model-ready financial truth | In progress | Financial truth is now the authoritative fail-closed gate for formal forecast, valuation, and market-expectations output; legacy three-period readiness is descriptive only. | DGKC has 4/5 annual income triplets, 0/5 OCF, 0/8 direct quarters, and no official share-count tie-out. The canonical FY25 issuer annual is the only permitted path for its OCF/capital-note evidence; its PSX distributor duplicate is not independent evidence and cannot fill the fifth annual year. |
