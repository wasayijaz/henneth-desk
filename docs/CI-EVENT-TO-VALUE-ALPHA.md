...
| 5 | Historical analogues | In progress | The MLCF/PIOC observed-case route now shows cutoff-safe, same-event raw-price context: -34.54% at 1Q and -19.40% at 2Q from the 2025-12-17 baseline. | This is a deterministic descriptive derived fact, not causal attribution, adjusted/total return, an analogue benchmark, a forecast, or a valuation input. Same-company/peer aggregate remains suppressed at n < 3; 4Q and 8Q outcomes are immature. |
