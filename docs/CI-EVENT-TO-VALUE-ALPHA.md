...
| 2026-08-31 | Diagnosed MARI's owner-approved FY26 annual `psx:280901` through the exact-ID transport gate. | The official DPS server declared a file above the normal 12 MiB cap, so the transport correctly stopped before download, hash binding, page inspection, receipt, or fact creation. A document-specific, hash-first bounded transport/chunk path is required before this filing can be assessed; the global cap is unchanged. |
