...
| Intelligence Case lifecycle | `state/company_intel/intelligence_cases.json` | 3 `Observed`, 0 `Corroborated`, 0 `Modelled`, 0 `Validated`, 0 `Published`, 0 `Monitoring`, 0 `Closed` | MLCF/PIOC, MARI E&P and MARI Sky47/Karakoram-01 are source-bound observed seeds only. None may activate forecast, valuation, expectations, recommendation, or publication. |
...
| C — sales-led | sales hiring, geography, branch/channel, product-sales infrastructure | MARI Sky47; PSO, GAL, BOP reviewed | Observed | MARI's official PSX `psx:280337` (2026-07-24, p.1) records its majority-owned Sky47 subsidiary launching the Karakoram-01 AI-ready data-centre campus. It is a distinct source-bound product-sales-infrastructure case, not MARI E&P. It remains Observed only: no qualified MARI financial history, customer contracts, capacity, utilisation, pricing, ramp or incremental economics are available. |
...
| 2 | Three real operating events | In progress | MLCF has an `Observed` Pioneer Cement control/acquisition case; MARI has separate `Observed` Peshawar E&P and Sky47/Karakoram-01 sales-led product-launch cases. | Exactly 3 cases are `Observed`; 0 are `Corroborated`, `Modelled`, `Validated`, `Published`, `Monitoring`, or `Closed`. None has independent corroboration, source-qualified incremental financial impact, or complete financial truth. |
