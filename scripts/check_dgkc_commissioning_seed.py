...
def main() -> None:
    ...
    check("observed corroborated", seed["status"] == "Observed" and seed["corroboration_status"] == "Corroborated")
    ...
    for bad_status in ("Modelled", "Published"):
    ...
    for bad_formal in ("Modelled", "Published"):
        candidate = copy.deepcopy(seed)
