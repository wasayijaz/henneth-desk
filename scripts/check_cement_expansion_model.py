...
def main() -> None:
    ...
    mutations = [
        ...
        ("discount 101", lambda c: c["inputs"]["discount_rate_pct_annual"].update(value=101.0), "discount_rate_pct_annual: must be in (0, 100)"),
        ("discount extreme", lambda c: c["inputs"]["discount_rate_pct_annual"].update(value=1e308), "discount_rate_pct_annual: must be in (0, 100)"),
